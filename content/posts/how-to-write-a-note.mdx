...
<div className="note-img-center">
  <figure>
    <img src="/images/photo.jpg" alt="描述" width={400} />
    <figcaption className="note-figcaption">图 1：这是说明文字</figcaption>
  </figure>
</div>
```
...
<div className="note-img-row">
  <img src="/images/a.jpg" alt="A" width={200} />
  <img src="/images/b.jpg" alt="B" width={200} />
</div>
```

> ⚠️ 使用 HTML 标签（`<div>`、`<img>` 等）时，文件必须保存为 `.mdx` 格式。
